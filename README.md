...
They assert the invariants the hand-rolled primitives are supposed to satisfy, Haar DWT perfect reconstruction and energy conservation, `istft(stft(x)) ≈ x` in
